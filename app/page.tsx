    ...
    <div className="h-screen flex flex-col">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-4 py-4 z-10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-900">Leasy</h1>
          <div>
            <p className="text-sm text-gray-600">Verified lease takeover platform</p>
        </div>
          </div>
          <nav className="flex gap-4">
            <a href="/" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 border-b-2 border-blue-600">
              Browse Listings
            </a>
            <a href="/list" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900">
              List Your Lease
            </a>
          </nav>
      </header>
